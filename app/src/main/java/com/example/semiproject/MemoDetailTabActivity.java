...
public class MemoDetailTabActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_memo_detail_tab);
        ...
        tabLayout.addTab(tabLayout.newTab().setText("위치정보"));
    ...
    class MyPagerAdopter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            switch (position) {
                case 0:
                    return new NewMemo_WriteFragment();
                case 1:
                    return new NewMemo_CameraFragment();
                case 2:
                    return new NewMemo_LocationFragment();
            }
            return null;
        }
